...
export default function HomePage() {
    ...
    return (
        <div className="relative min-h-screen pl-7 pr-7">
            <main className="bg-gray-50 dark:bg-gray-900 transition-colors">
                {data?.location && (
                    <div className="mt-8 mx-4 lg:mx-8 flex flex-col lg:flex-row items-stretch gap-6">
                        {/* Current Weather Card */}
                        <div className="w-full lg:basis-1/3 h-full">
